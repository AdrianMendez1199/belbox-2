    ...
    <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
        <section class="content-header"><!-- Content Header (Page header) -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Búsqueda archivos</li>
            </ol>
        </section>
                    ...
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>01/05/2008</td>
                          <td>
                            <span class="label label-success">Visualizar</span>
                        ...
                        <tr>
                          ...
                          <td>01/05/2008</td>
                          <td>
                            <span class="label label-warning">Visualizar</span>
                            <span class="label label-warning">Descargar</span>
                            <span class="label label-warning">Imprimir</span>
                            <span class="label label-danger">En tránsito</span>
                          </td>
                        </tr>
                        <tr>
                          <td>25</td>
      ...
      <aside class="aside-menu">
        ...
        <iframe src="images/4149.pdf" width="600" height="780" style="border: none;"></iframe>
        <!-- Tab panes-->
